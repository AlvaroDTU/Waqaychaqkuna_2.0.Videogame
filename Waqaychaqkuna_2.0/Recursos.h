...
public:
    ...
    //static Bitmap^ manipulador = gcnew Bitmap("sprites\\manipulador.png");
    //
    ...
    //static Bitmap^ visitante5 = gcnew Bitmap("sprites\\visitante5.png");
    //static Bitmap^ visitante6 = gcnew Bitmap("sprites\\visitante6.png");
    //
    //static Bitmap^ bat = gcnew Bitmap("sprites\\bat.png");
};